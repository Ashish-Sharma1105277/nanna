	...
	render() {
		return (
			<View style={styles.container}>
				<ScrollView>
				 <LinearGradient colors={['#FFB7AF', '#FEA89F']} style={styles.gradient} start={{ x: 0.7, y: 0 }}>        
				...
				{this.state.buttonDisplay === true ? <View style={[styles.footer, this.state.buttonDisplay === true && this.state.initialQuestion === false ?{marginTop: "100%"} : this.state.initialQuestion === true && this.state.nextQuestion === true && this.state.buttonDisplay === true ? {marginTop: "10%"} : {marginTop: '50%'}]}>
